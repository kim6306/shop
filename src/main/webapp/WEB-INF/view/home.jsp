    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                <div class="member">
                    <img src="${pageContext.request.contextPath}/assets/img/team/team-1.jpg" alt="">
                    <h4>จารุกิตติ์ กัญญา</h4>
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                <div class="member">
                    <img src="${pageContext.request.contextPath}/assets/img/team/PM.jpg" alt="">
                    <h4>สุรเชษฐ ลาภโต</h4>
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                <div class="member">
                    <img src="${pageContext.request.contextPath}/assets/img/team/team-3.jpg" alt="">
                    <h4>พชร สมบูรณ์ชัย</h4>
                    <span>CTO</span>
                    <p>
