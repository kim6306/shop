...
public class ProductController {
    ...
    public String showShopForAdd(@PathVariable("id") int id, Model model) {
        Product product = productService.getProduct(id);
        List<Shop> shops = productService.getShopDoesNotHaveProduct(id);
    ...
    public String addShop(@PathVariable("id") int productId,
                          @RequestParam("shop") int shopId) {
        productService.addShopToProduct(productId, shopId);
        return "redirect:/product/" + productId + "/shop/add";
    }

    @GetMapping("/{id}/shop/{shop}/remove")
    public String productRemoveShop(@PathVariable("id") int productId,
                                    @PathVariable("shop") int shopId) {
